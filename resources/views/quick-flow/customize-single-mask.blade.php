...
@section('content')
    ...
    <div id="customizer-app" class="container mx-auto mb-12">
        ...
        <div class="space-y-2 mb-2 text-left">
            ...
            <p class="text-slate-500 font-medium text-xs  ">Customize each image by uploading photos and adding text.</p>
        </div>
    ...
    <script>
        const customizer = {
            ...
            init() {
                ...
                // 3. Set Active Canvas (first enabled one)
