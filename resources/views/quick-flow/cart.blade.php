            ...
            @foreach($cart->items as $item)
                ...
                <div class="bg-white border-2 border-slate-50 rounded-[2rem] shadow-premium overflow-hidden cart-item-enter"
                    ...
                    <div class="p-4 flex gap-4">
                        ...
                        <div class="fanned-card-stage relative flex items-center justify-center w-24 h-24 shrink-0 select-none py-1 px-1">
                            @if($imageCount > 0)
                                ...
                                @endif
                            @else
                                <div class="w-16 h-16 rounded-xl overflow-hidden bg-slate-50 border border-slate-200/80 shrink-0 relative flex flex-col items-center justify-center text-slate-300 shadow-2xs">
