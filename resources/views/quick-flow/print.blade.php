    ...
    <div class="screen-only">
        ...
        <div class="preview-card">
            ...
            <div class="preview-info">
                ...
                <div style="font-weight: 800; color: #6FBA3B; font-size: 1.125rem;">
        ...
        <div class="btn-row">
            <a href="{{ route('flow.print.pdf', $order->id) }}" target="_blank" class="btn btn-print" style="background: linear-gradient(135deg, #6FBA3B, #5A9A2F);">
