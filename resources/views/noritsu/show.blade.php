    ...
    <div class="grid lg:grid-cols-2 gap-12">
        ...
        <div>
            ...
            <div class="flex items-center gap-4 mb-8 pb-8 border-b border-surface-100">
                <span class="text-3xl font-bold text-surface-900">{{ \App\Services\CurrencyService::format($product->base_price, 0) }}</span>
                @if($product->compare_price)
                <span class="text-lg text-surface-400 line-through">{{ \App\Services\CurrencyService::format($product->compare_price, 0) }}</span>
