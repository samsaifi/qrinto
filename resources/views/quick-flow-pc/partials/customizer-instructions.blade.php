    ...
    <div class="bg-white/80 backdrop-blur-xl border border-slate-200/80 rounded-3xl p-6 sm:p-8 lg:p-10 shadow-xl shadow-slate-200/40">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 mb-8 border-b border-slate-100">
            <div class="flex items-center gap-3.5">
                <div class="w-12 h-12 rounded-2xl bg-brand-50 border border-brand-100 text-brand-600 flex items-center justify-center shadow-xs shrink-0">
                    <i data-lucide="help-circle" class="w-6 h-6"></i>
                </div>
                <div>
                    <div class="inline-flex items-center gap-1.5 text-brand-600 text-[11px] font-black uppercase tracking-wider mb-0.5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            {{-- Step 1 --}}
            <div class="group relative bg-slate-50/70 hover:bg-white border border-slate-200/70 hover:border-brand-300 rounded-2xl p-5 shadow-2xs hover:shadow-lg transition-all duration-300 flex flex-col justify-between">
                <div>
                    <div class="flex items-center justify-between mb-4">
                        <span class="w-7 h-7 rounded-xl bg-brand-100 text-brand-600 text-xs font-black flex items-center justify-center shadow-xs">01</span>
                        <div class="w-10 h-10 rounded-2xl bg-white text-brand-500 shadow-sm border border-slate-200/80 flex items-center justify-center group-hover:scale-110 transition-transform">
                            <i data-lucide="image-plus" class="w-5 h-5"></i>
                        </div>
                    </div>
                    <h3 class="text-sm font-extrabold text-slate-900 group-hover:text-brand-600 transition-colors mb-1.5">Upload Photo</h3>
                    <p class="text-xs text-slate-500 leading-relaxed">Add high resolution photos from your device, phone, or drag and drop onto canvas.</p>
                </div>
                <div class="mt-4 pt-3 border-t border-slate-100 flex items-center gap-1.5 text-[11px] font-bold text-brand-600">
            ...
            <div class="group relative bg-slate-50/70 hover:bg-white border border-slate-200/70 hover:border-purple-300 rounded-2xl p-5 shadow-2xs hover:shadow-lg transition-all duration-300 flex flex-col justify-between">
                <div>
                    ...
                    <h3 class="text-sm font-extrabold text-slate-900 group-hover:text-purple-600 transition-colors mb-1.5">Add Custom Text</h3>
                    <p class="text-xs text-slate-500 leading-relaxed">Type names, quotes, or dates. Choose custom fonts, sizes, and colors.</p>
                </div>
            ...
            <div class="group relative bg-slate-50/70 hover:bg-white border border-slate-200/70 hover:border-emerald-300 rounded-2xl p-5 shadow-2xs hover:shadow-lg transition-all duration-300 flex flex-col justify-between">
                <div>
                    ...
                    <h3 class="text-sm font-extrabold text-slate-900 group-hover:text-emerald-600 transition-colors mb-1.5">Scale & Position</h3>
                    <p class="text-xs text-slate-500 leading-relaxed">Drag handles to rotate, shrink, stretch, or align design elements perfectly.</p>
                </div>
            ...
            <div class="group relative bg-slate-50/70 hover:bg-white border border-slate-200/70 hover:border-brand-300 rounded-2xl p-5 shadow-2xs hover:shadow-lg transition-all duration-300 flex flex-col justify-between">
                <div>
                    <div class="flex items-center justify-between mb-4">
                        <span class="w-7 h-7 rounded-xl bg-brand-100 text-brand-600 text-xs font-black flex items-center justify-center shadow-xs">04</span>
                        <div class="w-10 h-10 rounded-2xl bg-white text-brand-500 shadow-sm border border-slate-200/80 flex items-center justify-center group-hover:scale-110 transition-transform">
                            <i data-lucide="layout-template" class="w-5 h-5"></i>
                        </div>
                    </div>
                    <h3 class="text-sm font-extrabold text-slate-900 group-hover:text-brand-600 transition-colors mb-1.5">Templates & Pages</h3>
            ...
            {{-- Step 5 --}}
            <div class="group relative bg-slate-50/70 hover:bg-white border border-slate-200/70 hover:border-brand-hover rounded-2xl p-5 shadow-2xs hover:shadow-lg transition-all duration-300 flex flex-col justify-between">
                <div>
                    <div class="flex items-center justify-between mb-4">
                    ...
                    <h3 class="text-sm font-extrabold text-slate-900 group-hover:text-brand-hover transition-colors mb-1.5">Save & Checkout</h3>
