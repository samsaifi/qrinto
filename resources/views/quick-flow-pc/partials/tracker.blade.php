...
<div class="py-2 px-1">
    <div
        class="space-y-6 relative before:absolute before:left-3.5 before:top-4 before:bottom-4 before:w-0.5 before:bg-slate-200">
        @foreach ($stages as $index => $stage)
            ...
            <div class="flex items-start gap-4 relative z-10">
                <div
                    class="w-7 h-7 rounded-full flex items-center justify-center shrink-0 border-2 transition-all
                ...
                <div class="pt-0.5">
                    ...
                    <p
                        class="text-[11px] {{ $isCurrent ? 'text-[#287d3c] font-bold' : 'text-slate-400 font-normal' }} mt-0.5">
                        @if ($isCurrent)
                            Current Status
