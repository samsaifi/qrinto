...
<head>
    ...
    <title>Print Design Preview — {{ $order->order_number }} | Qrinto</title>
    ...
    <div class="screen-only">
        ...
        <div class="preview-card">
            ...
            <div class="preview-info">
                ...
                <div style="font-weight: 800; color: var(--color-brand-500); font-size: 1.125rem;">
        ...
        <div class="btn-row">
            <a href="{{ route('flow-pc.confirmation', $order->id) }}" class="btn btn-back">
