    ...
    <div class="ambient-bg min-h-screen py-8 -mt-6 font-sans text-slate-900">
        <div class="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center max-w-2xl mx-auto mb-10 fade-up">
                <div
                    class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-50 border border-brand-100 text-brand-600 text-xs font-extrabold mb-3">
                ...
                <p class="text-slate-500 text-sm sm:text-base font-medium mt-3 leading-relaxed">
                    Enter your order tracking number below to view real-time fulfillment, printing status, and store pickup
                    details.
                </p>
            </div>
            ...
            <div class="max-w-lg mx-auto mb-14 fade-up" style="animation-delay: 0.1s">
                ...
                @if (session('error'))
                    <div
                        class="w-full bg-red-50/90 border-2 border-red-200 text-red-700 p-4 mb-6 rounded-2xl text-left text-xs font-bold flex items-center gap-3 shadow-sm">
                ...
                <div
                    class="glass-card border border-slate-200/90 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-slate-200/50 relative overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto fade-up" style="animation-delay: 0.2s">
                <div class="glass-card p-6 rounded-3xl border border-slate-200/80 shadow-xs flex items-start gap-4">
                    <div
                        class="w-12 h-12 rounded-2xl bg-brand-50 border border-brand-100 text-brand-600 flex items-center justify-center shrink-0">
                        <i data-lucide="truck" class="w-6 h-6"></i>
                    </div>
                    <div>
                        <h4 class="font-extrabold text-base text-slate-900">Live Stage Tracking</h4>
                        <p class="text-xs text-slate-500 font-medium mt-1">Track exact prep, printing, and packaging
                ...
                <div class="glass-card p-6 rounded-3xl border border-slate-200/80 shadow-xs flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 font-medium mt-1">View pickup location, hours, and store contact
                            information.</p>
                    </div>
                </div>
                ...
                <div class="glass-card p-6 rounded-3xl border border-slate-200/80 shadow-xs flex items-start gap-4">
                    <div
                        class="w-12 h-12 rounded-2xl bg-purple-50 border border-purple-100 text-purple-600 flex items-center justify-center shrink-0">
                        <i data-lucide="bell" class="w-6 h-6"></i>
                    </div>
                    <div>
                        <h4 class="font-extrabold text-base text-slate-900">Instant Updates</h4>
                        <p class="text-xs text-slate-500 font-medium mt-1">Receive automated email & SMS alerts when your
                            print is ready.</p>
                    </div>
                </div>
            </div>
