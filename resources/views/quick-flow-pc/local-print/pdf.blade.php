...
@section('title', 'Print a PDF | Qrinto')
...
@section('content')
    <div class="w-full bg-[#fafcf9] min-h-screen py-10 px-6 lg:px-16 font-sans">
        <div class="max-w-[820px] mx-auto">
            ...
            <h1 class="text-2xl font-extrabold text-[#112419] tracking-tight mt-4">Print a PDF</h1>
            ...
            <form method="POST" action="{{ route('localprint.upload') }}" enctype="multipart/form-data" class="mt-6"
                ...
                <label
                    ...
                    <input type="file" name="pdf" accept="application/pdf" class="hidden" x-ref="file"
                    ...
                    <p class="font-bold text-slate-800 mt-4" x-text="name || 'Drop a PDF here, or click to choose'"></p>
                    <p class="text-xs text-slate-400 mt-1">One file at a time, up to 200 MB</p>
                </label>
            </form>
