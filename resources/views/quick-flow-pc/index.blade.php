...
@section('title', 'Custom Photo Printing, Personalised Greeting Cards & Photo Gifts | Qrinto')
@section('header_title', 'Create')
@section('meta_description',
    'Design and order custom greeting cards, photo prints, business cards, photo books, and
    personalized gifts with Qrinto. Real-time online studio with fast local store pickup.')
@section('meta_keywords',
    'custom photo printing, online print studio, personalised greeting cards, photo prints, custom
    business cards, photo books, custom gifts, canvas prints, photo studio pickup, Qrinto')
@section('canonical_url', route('flow-pc.index'))
@section('og_type', 'website')
@section('og_title', 'Custom Photo Printing, Personalised Greeting Cards & Photo Gifts | Qrinto')
@section('og_description',
    'Turn your memories into extraordinary prints. Real-time online studio for custom greeting
    cards, photo prints, canvas art, and personalized stationery with instant store pickup.')
    ...
    <script type="application/ld+json">
{
  ...
  "@@graph": [
    {
      "@@type": "WebSite",
      "@@id": "{{ route('flow-pc.index') }}#website",
      "url": "{{ route('flow-pc.index') }}",
      "name": "Qrinto Print Studio",
      "description": "Next-generation interactive print studio for custom photo printing, greeting cards, and stationery.",
      "publisher": {
        "@@id": "{{ route('flow-pc.index') }}#organization"
      },
    ...
    },
    {
      ...
      "logo": {
        "@@type": "ImageObject",
        "url": "{{ asset('logo/Qrinto-logo-small.png') }}"
      }
    },
    {
      "@@type": "OnlineStore",
      "@@id": "{{ route('flow-pc.index') }}#store",
      "name": "Qrinto Custom Print Studio",
      "url": "{{ route('flow-pc.index') }}",
      "description": "Design and order custom photo prints, greeting cards, business cards, photo books, and personalized stationery with local store pickup.",
            ...
            <div class="max-w-[1400px] mx-auto">
                ...
                @php
                    $cardThemes = [
                        ...
                        [
                            'border' => ' border-gray-200/90 hover: border-gray-500 hover:shadow-emerald-500/10',
                            'bg' => 'bg-white',
                                    ...
                                    <a href="{{ route('flow-pc.category', $type->slug) }}"
                                        ...
                                        <div class="p-6 text-left flex-1 flex flex-col justify-between">
                                            <div>
                                                ...
                                                @else
                                                    <p class="text-xs text-slate-400 mt-1.5">Custom premium printing
                                                        studio
                                                        options</p>
                                                @endif
                                            </div>
                ...
                <div class="grid grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    <div class="col-span-12 lg:col-span-5">
                        ...
                        <p class="text-base sm:text-lg text-slate-600 mt-5 leading-relaxed font-medium">
                            ...
                            deliver borderless and edge-to-edge prints.
                        </p>
                            ...
                            @php
                                $features = [
                                    ...
                                    [
                                        ...
                                        'border' =>
                                            ' border-gray-200/90 hover: border-gray-500 hover:shadow-emerald-500/10',
                                        'iconBox' => 'bg-brand-500 text-white shadow-lg shadow-brand-500/30',
                                        'titleColor' => 'group-hover: text-gray-600',
                                    ],
                                ];
                            @endphp
                        ...
                        @php
                            $reviews = [
                                [
                                    ...
                                    'rating' => '5.0',
                                    'text' =>
                                        'Introducing the Noritsu 931-BL right before the Holiday season was the best decision we made. The print speed helped us keep up with customer demand even during peak times, and the edge-to-edge printing meant we had a finished product, ready to go.',
                                ],
                                [
                                    'name' => 'Retail Manager',
                                    'studio' => 'Downtown Prints & Gifts',
                                    'initials' => 'RM',
                                    ...
                                    'rating' => '5.0',
                                    'text' =>
                                        'The Noritsu 931-BL has truly transformed how we produce creative products in-store. The fast turnaround delights our customers, and the compact footprint lets us operate efficiently even in our limited space.',
                                ],
                                [
                                    'name' => 'Store Owner',
                                    'studio' => 'Family Prints Studio',
                                    'initials' => 'SO',
                                    ...
                                    'rating' => '5.0',
                                    'text' =>
                                        'Since adding the Noritsu 931-BL to our business, we’ve seen a 15% increase in overall sales. The quality of prints and creative output leaves a lasting impression on our customers—we’re confident we’re delivering the highest standard with every order',
                                ],
                            ];
                        @endphp
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center gap-3.5">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-slate-400 font-medium">{{ $review['studio'] }}
                                                </p>
                                            </div>
                                        </div>
                                        <span
                                            class="inline-flex items-center gap-1 text-[11px] font-bold  text-gray-600  bg-gray-50 px-2.5 py-1 rounded-full border  border-gray-200/60">
                                            <i data-lucide="check-circle-2" class="w-3.5 h-3.5  text-gray-500"></i>
                                            Verified Buyer
                                        </span>
                                    </div>
                                </div>
