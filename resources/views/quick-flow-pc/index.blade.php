 ...
 @section('content')
     <div class=" ">
             ...
             <div class="max-w-[1400px] mx-auto w-full relative z-10">
                 ...
                 <div class="grid grid-cols-12 gap-6 lg:gap-10 items-center">
                     ...
                     <div class="col-span-12 lg:col-span-6">
                         ...
                         <!-- Heading -->
                         <h1
                             class="text-3xl sm:text-4xl xl:text-5xl font-black text-slate-900 leading-tight tracking-tight">
         ...
         <section class="w-full bg-gray-100 py-24 px-6 sm:px-10 border-b border-slate-200/80 relative overflow-hidden">
             ...
             <div
                 class="absolute -bottom-32 -right-32 w-96 h-96 bg-purple-500/5 rounded-full blur-3xl pointer-events-none">
             </div>
