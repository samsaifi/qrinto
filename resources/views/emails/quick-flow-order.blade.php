                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td align="center" style="padding: 36px 32px 12px;">
                            <table role="presentation" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center"
                                        style="width: 72px; height: 72px; background: linear-gradient(135deg, {{ $isAdmin ? '#d97706, #f59e0b' : '#0ea5e9, #16a34a' }}); border-radius: 50%; text-align: center; vertical-align: middle;">
                                        <span
                                            style="font-size: 36px; color: #ffffff; line-height: 72px;">{{ $isAdmin ? '🔔' : '✓' }}</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center" style="padding: 0 32px 8px;">
                            @if ($isAdmin)
                                <p style="margin: 0; font-size: 14px; color: #0ea5e9; font-weight: 500;">A new Quick
                                    Flow order has been placed</p>
                            @else
                                <p style="margin: 0; font-size: 14px; color: #0ea5e9; font-weight: 500;">Hello
                                    {{ $order->shipping_address['name'] ?? 'Customer' }}, we're getting your order
                                    ready!</p>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 0 32px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td
                                        style="padding: 12px 16px; font-size: 13px; font-weight: 600; color: #0ea5e9; border-bottom: 1px solid #f1f5f9; width: 40%; background: #f8fafc;">
                                        Product</td>
                                    <td
                                        style="padding: 12px 16px; font-size: 14px; font-weight: 700; color: #0f172a; border-bottom: 1px solid #f1f5f9;">
                                        {{ $order->items->first()->product_name ?? 'N/A' }}</td>
                                </tr>
                                <!-- Type -->
                                <tr>
                                    <td
                                        style="padding: 12px 16px; font-size: 13px; font-weight: 600; color: #0ea5e9; border-bottom: 1px solid #f1f5f9; background: #f8fafc;">
                                        Type</td>
                                    <td
                                        style="padding: 12px 16px; font-size: 14px; font-weight: 700; color: #0f172a; border-bottom: 1px solid #f1f5f9;">
                                        {{ $order->flow_data['type_name'] ?? 'Custom' }}</td>
                                </tr>
                                <!-- Size -->
                                <tr>
                                    <td
                                    ...
                                    <td
                                        style="padding: 12px 16px; font-size: 14px; font-weight: 700; color: #0f172a; border-bottom: 1px solid #f1f5f9;">
                                        {{ $order->flow_data['size_name'] ?? 'Standard' }}</td>
                                </tr>
                                <!-- Dimensions -->
                                <tr>
                                    <td
                                    ...
                                    <td
                                        style="padding: 12px 16px; font-size: 14px; font-weight: 700; color: #0f172a; border-bottom: 1px solid #f1f5f9;">
                                        {{ $order->flow_data['size_width'] ?? '0' }} x
                                        {{ $order->flow_data['size_height'] ?? '0' }}{{ $order->flow_data['size_unit'] ?? '"' }}
                                    </td>
                                </tr>
                                <!-- Quantity -->
                                <tr>
                                    <td
                                        ...
                                        Quantity</td>
                                    <td
                                        style="padding: 12px 16px; font-size: 14px; font-weight: 700; color: #0284c7; border-bottom: 1px solid #f1f5f9;">
                                        {{ $order->total_quantity ?? $order->items->sum('quantity') }} Units</td>
                                </tr>
                                <!-- Payment -->
                                <tr>
                                    <td
                                    ...
                                    <td
                                        ...
                                        ({{ strtoupper($order->payment_status) }})</td>
                                </tr>
                                <!-- Total -->
                                <tr>
                                    <td
                                        style="padding: 14px 16px; font-size: 15px; font-weight: 700; color: #1e293b; border-top: 2px solid #e2e8f0; background: #f8fafc;">
                                        Total</td>
                                    <td
                                        style="padding: 14px 16px; font-size: 20px; font-weight: 900; color: #0284c7; border-top: 2px solid #e2e8f0;">
                        ...
                        <td style="padding: 0 32px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="padding: 12px 16px; font-size: 14px; font-weight: 700; color: #0f172a; border-bottom: 1px solid #f1f5f9;">
                                        <a href="mailto:{{ $order->guest_email ?? 'N/A' }}"
                                            style="color: #0284c7; text-decoration: none; font-weight: 600;">{{ $order->guest_email ?? 'N/A' }}</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td
                                        style="padding: 12px 16px; font-size: 13px; font-weight: 600; color: #0ea5e9; background: #f8fafc;">
                                        Phone</td>
                                    <td style="padding: 12px 16px; font-size: 14px; font-weight: 700; color: #0f172a;">
                                        <a href="tel:{{ $order->guest_phone ?? '' }}"
                                            style="color: #0284c7; text-decoration: none; font-weight: 600;">{{ $order->guest_phone ?? 'N/A' }}</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td style="padding: 24px 32px 4px;">
                            @if ($isAdmin)
                                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td
                                            style="background: #fffbeb; border: 1px solid #fde68a; border-radius: 12px; padding: 14px 18px;">
                                            <p style="margin: 0; font-size: 13px; color: #92400e; font-weight: 600;">📎
                                                <strong>Note:</strong> The print-ready design PDF is attached to this
                                                email.
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <p style="margin: 0; font-size: 13px; color: #15803d; font-weight: 500;">📩
                                                You will receive another update as soon as your order is ready for
                                                pickup at our branch.</p>
                                        </td>
                                    </tr>
                                </table>
                            @endif
                    ...
                    <tr>
                        <td style="padding: 24px 32px 8px;">
                            <p style="margin: 0 0 2px; font-size: 14px; color: #0ea5e9;">Best regards,</p>
                    ...
                    <tr>
                        <td align="center" style="padding: 20px 32px;">
                            <p style="margin: 0; font-size: 12px; color: #94a3b8; line-height: 1.5;">&copy;
                                {{ date('Y') }} Qrinto Custom Printing Studio. All rights reserved.</p>
                        </td>
                    </tr>
                </table>
