                    ...
                    <tr>
                        <td align="center" style="padding: 8px 32px 4px;">
                            <h1
                                ...
                                Order Status Updated</h1>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="padding: 0 32px 8px;">
                            <p style="margin: 0; font-size: 14px; color: #0ea5e9; font-weight: 500;">Your order
                                #{{ $order->order_number }} has been updated</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 8px 32px 20px;">
                            <table role="presentation" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td
                                        style="background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 50px; padding: 6px 16px;">
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <p
                                                ...
                                                Details</p>
                                            <p
                                                style="margin: 0; font-size: 14px; color: #334155; font-weight: 500; line-height: 1.5;">
                                                {{ $notes }}</p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td
                                            ...
                                            <p
                                                style="margin: 0 0 6px; font-size: 11px; font-weight: 700; color: #94a3b8; text-transform: uppercase; letter-spacing: 1px;">
                                                Shipping Info</p>
                                            <p style="margin: 0 0 4px; font-size: 14px; color: #334155;">
                                                <strong>Tracking:</strong> {{ $order->tracking_number }}
                                            </p>
                                            @if ($order->tracking_url)
                                                <p style="margin: 0;"><a href="{{ $order->tracking_url }}"
                                                        style="font-size: 13px; color: #0284c7; font-weight: 600; text-decoration: underline;">Track
                                                        Shipment →</a></p>
                                            @endif
                                        </td>
                                    </tr>
                        ...
                        <tr>
                            <td style="padding: 0 32px 16px;">
                                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td
                                            style="background: linear-gradient(135deg, #f0fdf4, #dcfce7); border: 1px solid #bbf7d0; border-radius: 12px; padding: 14px 18px; text-align: center;">
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td align="center" style="padding: 20px 32px;">
                            <p style="margin: 0; font-size: 12px; color: #94a3b8; line-height: 1.5;">This email was
                                sent by {{ config('app.name') }}. If you have questions, reply to this email or contact
                                the store directly.</p>
                        </td>
                    </tr>
                </table>
