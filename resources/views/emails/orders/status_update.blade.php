                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 520px; background: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.06);">
                    ...
                    <tr>
                        <td align="center" style="padding: 36px 32px 12px;">
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="width: 72px; height: 72px; background: linear-gradient(135deg, #22c55e, #16a34a); border-radius: 50%; text-align: center; vertical-align: middle;">
                    ...
                    <tr>
                        <td align="center" style="padding: 8px 32px 4px;">
                            <h1 style="margin: 0; font-size: 24px; font-weight: 800; color: #0f172a; letter-spacing: -0.5px;">Order Status Updated</h1>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="padding: 0 32px 8px;">
                            <p style="margin: 0; font-size: 14px; color: #64748b; font-weight: 500;">Your order #{{ $order->order_number }} has been updated</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 8px 32px 20px;">
                            <table role="presentation" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 50px; padding: 6px 16px;">
                                        <span style="font-size: 12px; font-weight: 700; color: #15803d;">● {{ ucfirst($order->status) }}</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 14px 18px;">
                                        <p style="margin: 0 0 2px; font-size: 11px; font-weight: 700; color: #94a3b8; text-transform: uppercase; letter-spacing: 1px;">Details</p>
                                        <p style="margin: 0; font-size: 14px; color: #334155; font-weight: 500; line-height: 1.5;">{{ $notes }}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 12px; padding: 14px 18px;">
                                        <p style="margin: 0 0 6px; font-size: 11px; font-weight: 700; color: #94a3b8; text-transform: uppercase; letter-spacing: 1px;">Shipping Info</p>
                                        <p style="margin: 0 0 4px; font-size: 14px; color: #334155;"><strong>Tracking:</strong> {{ $order->tracking_number }}</p>
                                        @if($order->tracking_url)
                                        <p style="margin: 0;"><a href="{{ $order->tracking_url }}" style="font-size: 13px; color: #0284c7; font-weight: 600; text-decoration: underline;">Track Shipment →</a></p>
                                        @endif
                                    </td>
                                </tr>
                            </table>
                    ...
                    @if($order->status === 'delivered_store' || $order->status === 'completed' || $order->status === 'ready')
                    <!-- Ready for Pickup Banner -->
                    <tr>
                        <td style="padding: 0 32px 16px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="background: linear-gradient(135deg, #f0fdf4, #dcfce7); border: 1px solid #bbf7d0; border-radius: 12px; padding: 14px 18px; text-align: center;">
                                        <p style="margin: 0; font-size: 15px; font-weight: 700; color: #15803d;">🎉 Your order is ready for pickup!</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center" style="padding: 4px 32px 24px;">
                            <table role="presentation" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="background: linear-gradient(135deg, #0284c7, #0ea5e9); border-radius: 14px; box-shadow: 0 4px 14px rgba(2,132,199,0.35);">
                                        <a href="{{ route('flow.track.order', ['orderNumber' => $order->order_number]) }}" style="display: inline-block; padding: 14px 36px; font-size: 15px; font-weight: 800; color: #ffffff; text-decoration: none; letter-spacing: 0.3px;">Track Order Progress →</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 0 32px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
                                <!-- Table Header -->
                                <tr>
                                    <td style="background: linear-gradient(135deg, #0284c7, #0ea5e9); padding: 10px 14px; font-size: 11px; font-weight: 700; color: #ffffff; text-transform: uppercase; letter-spacing: 1.2px; text-align: left; width: 55%;">Item</td>
                                    <td style="background: linear-gradient(135deg, #0284c7, #0ea5e9); padding: 10px 14px; font-size: 11px; font-weight: 700; color: #ffffff; text-transform: uppercase; letter-spacing: 1.2px; text-align: center; width: 20%;">Qty</td>
                                    <td style="background: linear-gradient(135deg, #0284c7, #0ea5e9); padding: 10px 14px; font-size: 11px; font-weight: 700; color: #ffffff; text-transform: uppercase; letter-spacing: 1.2px; text-align: right; width: 25%;">Price</td>
                                </tr>
                                <!-- Table Body -->
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 14px; font-size: 14px; color: #0284c7; font-weight: 600; border-bottom: 1px solid #f1f5f9; text-align: center;">{{ $item->quantity }}</td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 14px; font-size: 18px; font-weight: 900; color: #0284c7; border-top: 2px solid #e2e8f0; text-align: right;">{{ \App\Services\CurrencyService::formatWithCurrency($order->total, $order->currency) }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 28px 32px 8px;">
                            <p style="margin: 0 0 2px; font-size: 14px; color: #64748b;">Thanks for choosing Qrinto,</p>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 520px;">
                    <tr>
                        <td align="center" style="padding: 20px 32px;">
                            <p style="margin: 0; font-size: 12px; color: #94a3b8; line-height: 1.5;">This email was sent by {{ config('app.name') }}. If you have questions, reply to this email or contact the store directly.</p>
                        </td>
                    </tr>
                </table>
