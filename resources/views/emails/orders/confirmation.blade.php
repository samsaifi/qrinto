                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 520px; background: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.06);">
                    ...
                    <tr>
                        <td align="center" style="padding: 8px 32px 4px;">
                            <h1 style="margin: 0; font-size: 24px; font-weight: 800; color: #0f172a; letter-spacing: -0.5px;">Order Confirmed!</h1>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="padding: 0 32px 8px;">
                            <p style="margin: 0; font-size: 14px; color: #64748b; font-weight: 500;">Thank you for your order. We're getting it ready!</p>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="50%" style="padding-left: 6px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 12px 14px; text-align: center;">
                                                    <p style="margin: 0 0 2px; font-size: 10px; font-weight: 700; color: #94a3b8; text-transform: uppercase; letter-spacing: 1px;">Payment</p>
                                                    <p style="margin: 0; font-size: 14px; font-weight: 700; color: {{ $order->payment_status === 'paid' ? '#15803d' : '#b45309' }};">{{ ucfirst($order->payment_status) }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
