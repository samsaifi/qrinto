                            ...
                            <td class="px-5 py-3 max-w-[220px]">
                                @if ($kioskItem->file_path)
                                    <a href="{{ Str::startsWith($kioskItem->file_path, ['http://', 'https://']) ? $kioskItem->file_path : asset('storage/' . $kioskItem->file_path) }}"
                                        target="_blank"
                                        class="inline-flex items-center gap-1.5 text-xs font-medium text-[#287d3c] hover:underline truncate"
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-5 py-16 text-center text-sm text-slate-400">
                                No kiosk logs found for this store.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
