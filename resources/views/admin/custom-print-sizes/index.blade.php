...
@section('content')
    <div class="flex items-center justify-between mb-8">
        ...
        <a href="{{ route('admin.custom-print-sizes.create') }}"
    ...
    <div class="mb-6 p-4  bg-gray-50 border  border-gray-200  text-gray-800 rounded-xl flex items-center gap-3 text-sm">
        ...
        <span>These sizes and prices are displayed to customers on the <strong>Custom Print</strong> page when they upload
            their own designs.</span>
    </div>
                        ...
                        <tr class="hover:bg-surface-50 transition">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('admin.custom-print-sizes.edit', $size) }}"
                                        class="p-2 rounded-lg hover:bg-surface-100 text-surface-500 hover:text-brand-600 transition"
                                        title="Edit">
                                        <i data-lucide="pencil" class="w-4 h-4"></i>
                                    </a>
                                    <form action="{{ route('admin.custom-print-sizes.destroy', $size) }}" method="POST"
