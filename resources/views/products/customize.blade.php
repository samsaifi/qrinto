                ...
                <div class="bg-white rounded-2xl border border-surface-100 shadow-card p-6">
                    ...
                    <div class="border-t border-surface-100 pt-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-lg font-semibold text-surface-800" x-text="formattedUnitPrice">${{ number_format($product->base_price, 0) }}</span>
                        </div>
                        <div class="flex justify-between items-center mt-2">
                            <span class="font-display font-bold text-surface-900">Total</span>
                            <span class="text-2xl font-bold text-brand-600" x-text="formattedTotalPrice">${{ number_format($product->base_price, 0) }}</span>
                        </div>
                    </div>
                </div>
